...
public class Coachtable {
	@Id
	@GenericGenerator(name="coachid_gen",strategy="com.wecare.utility.CoachIdGenerator")
	@GeneratedValue(generator="coachid_gen")
	...
	public Coachtable(String coach_id, String name, String gender, LocalDate date_of_birth, String password,
